...
const en = {
  ...
  'actor.wecode_claude': 'WeCode Claude',
  'actor.wecode_codex': 'WeCode Codex',
  'actor.wecode_opencode': 'WeCode OpenCode',
  'actor.human': 'You',
  'actor.system': 'System',
  ...
  'status.RUNNING_WECODE_CLAUDE': 'WeCode Claude running',
  'status.RUNNING_WECODE_CODEX': 'WeCode Codex running',
  'status.RUNNING_WECODE_OPENCODE': 'WeCode OpenCode running',
  ...
  // Settings — Agent Launchers
  'settings.cli.title': 'Agent Launchers',
  'settings.cli.desc': 'Configure launch methods (CLI / ACP protocol) and parameters for each agent. Used as defaults when creating a new task.',
  'settings.launcher.internalToolsHeader': 'Internal Tooling · WeCode',
  ...
  'settings.launcher.wecode_claude.title': 'WeCode Claude configuration',
  'settings.launcher.wecode_claude.label': 'WeCode Claude launch command',
  'settings.launcher.wecode_codex.title': 'WeCode Codex configuration',
  'settings.launcher.wecode_codex.label': 'WeCode Codex launch command',
  'settings.launcher.wecode_opencode.title': 'WeCode OpenCode configuration',
  'settings.launcher.wecode_opencode.label': 'WeCode OpenCode launch command',
  'settings.launcher.claude.hint': 'Launch command for Claude Code. The launcher automatically uses --dangerously-skip-permissions in non-interactive mode.',
  ...
  'settings.launcher.wecode_claude.hint': 'Launch command for WeCode Claude. The launcher automatically uses --dangerously-skip-permissions in non-interactive mode.',
  'settings.launcher.wecode_codex.hint': 'Launch command for WeCode Codex. The launcher automatically uses non-interactive exec --dangerously-bypass-approvals-and-sandbox.',
  'settings.launcher.wecode_opencode.hint': 'Launch command for WeCode OpenCode. The launcher uses run --format json --dangerously-skip-permissions in non-interactive mode.',
  ...
  'settings.launcher.mode': 'Protocol mode',
  'settings.launcher.modeCli': 'CLI',
  'settings.launcher.modeAcp': 'ACP',
  'settings.launcher.presets': 'Quick Presets',
  'settings.launcher.args': 'Arguments',
  'settings.launcher.argsPlaceholder': 'e.g. acp',
  'settings.launcher.acpHint': 'Uses Agent Client Protocol (ACP) standard over stdio JSON-RPC',
  'settings.launcher.globalAdapterReady': 'Global adapter is ready ({bin}). Direct launch enabled (10x faster startup, zero npx overhead).',
  'settings.launcher.globalAdapterRecommended': 'Running via npx. Run "{cmd}" globally for 10x faster startup.',
  'settings.launcher.globalInstallPromptTitle': 'Recommended: Install Global ACP Adapter for 10x Faster Startup',
  'settings.launcher.globalInstallPromptDesc': 'Running via npx involves npm check and download overhead on each start. Install globally once to enjoy instant, zero-overhead direct launch.',
  'settings.launcher.copyInstallCmd': 'Copy Install Command',
  'settings.launcher.switchToDirect': 'Apply Direct Launch ({bin})',
  'settings.launcher.agyAcpWarning': 'Antigravity CLI (agy) does not support ACP mode natively. Please use CLI mode.',
  'settings.launcher.kimiAcpWarning': 'Kimi Code CLI (v0.6.0+) does not support ACP mode. Please use CLI mode.',
  ...
  'git.generateFailedDetail': 'Generation failed: {message}',
  ...
  'modal.create.model': 'Model',
  'modal.create.modelUnavailable': 'No models available',
  'modal.create.standardAgents': 'Coding Agents',
  'modal.create.internalAgents': 'Internal Tooling (WeCode)',
...
const zhCN: typeof en = {
  ...
  'status.RUNNING_WECODE_CLAUDE': 'WeCode Claude 运行中',
  'status.RUNNING_WECODE_CODEX': 'WeCode Codex 运行中',
  'status.RUNNING_WECODE_OPENCODE': 'WeCode OpenCode 运行中',
  'status.PAUSED': '已暂停',
  'status.FAILED': '失败',
  'status.DONE': '已完成',
  ...
  'settings.cli.title': 'Agent 启动配置',
  'settings.cli.desc': '配置各 Agent 的启动方式（CLI / ACP 协议）与运行参数。新建任务时会使用这些设置作为默认值。',
  'settings.launcher.internalToolsHeader': '内部工具支持 · WeCode',
  ...
  'settings.launcher.wecode_claude.title': 'WeCode Claude 配置',
  'settings.launcher.wecode_claude.label': 'WeCode Claude 启动命令',
  'settings.launcher.wecode_codex.title': 'WeCode Codex 配置',
  'settings.launcher.wecode_codex.label': 'WeCode Codex 启动命令',
  'settings.launcher.wecode_opencode.title': 'WeCode OpenCode 配置',
  'settings.launcher.wecode_opencode.label': 'WeCode OpenCode 启动命令',
  'settings.launcher.claude.hint': 'Claude Code 的启动命令。launcher 会自动使用 --dangerously-skip-permissions 非交互模式执行。',
  ...
  'settings.launcher.wecode_claude.hint': 'WeCode Claude 的启动命令。launcher 会自动使用 --dangerously-skip-permissions 非交互模式执行。',
  'settings.launcher.wecode_codex.hint': 'WeCode Codex 的启动命令。launcher 会自动使用 exec --dangerously-bypass-approvals-and-sandbox 非交互模式执行。',
  'settings.launcher.wecode_opencode.hint': 'WeCode OpenCode 的启动命令。launcher 会自动使用 run --format json --dangerously-skip-permissions 非交互模式执行。',
  ...
  'settings.launcher.mode': '协议模式',
  'settings.launcher.modeCli': 'CLI',
  'settings.launcher.modeAcp': 'ACP',
  'settings.launcher.presets': '快速预设',
  'settings.launcher.args': '运行参数',
  'settings.launcher.argsPlaceholder': '例如 acp',
  'settings.launcher.acpHint': '基于 Agent Client Protocol (ACP) 标准协议，通过 stdio 进行 JSON-RPC 交互',
  'settings.launcher.globalAdapterReady': '全局适配器已就绪（{bin}），秒级极速直连启动（提升 10 倍速度，无 npx 开销）。',
  'settings.launcher.globalAdapterRecommended': '当前通过 npx 运行。推荐运行 “{cmd}” 全局安装提速 10 倍。',
  'settings.launcher.globalInstallPromptTitle': '推荐：全局安装 ACP 适配器（提速 10 倍，无冷启动开销）',
  'settings.launcher.globalInstallPromptDesc': '当前通过 npx 运行，每次启动都存在 npm 检查和网络延迟。建议在终端中全局安装一次，即可享受零开销极速直连。',
  'settings.launcher.copyInstallCmd': '复制安装命令',
  'settings.launcher.switchToDirect': '应用全局直连（{bin}）',
  'settings.launcher.agyAcpWarning': 'Antigravity CLI (agy) 原生不支持 ACP 模式，建议切换为 CLI 模式。',
  'settings.launcher.kimiAcpWarning': 'Kimi Code CLI (v0.6.0+) 不支持 ACP 模式，建议切换为 CLI 模式。',
  ...
  'git.generateFailedDetail': '生成失败：{message}',
  ...
  'modal.create.model': '模型',
  'modal.create.modelUnavailable': '暂无可用模型',
  'modal.create.standardAgents': 'Coding Agent',
  'modal.create.internalAgents': '内部工具支持（WeCode）',
...
const zhTW: typeof en = {
  ...
  'status.RUNNING_WECODE_CLAUDE': 'WeCode Claude 執行中',
  'status.RUNNING_WECODE_CODEX': 'WeCode Codex 執行中',
  'status.RUNNING_WECODE_OPENCODE': 'WeCode OpenCode 執行中',
  'status.PAUSED': '已暫停',
  'status.FAILED': '失敗',
  'status.DONE': '已完成',
  'status.CANCELLED': '已取消',
  ...
  'settings.cli.title': 'Agent 啟動設定',
  'settings.cli.desc': '設定各 Agent 的啟動方式（CLI / ACP 協定）與執行參數。新增任務時會使用這些設定作為預設值。',
  'settings.launcher.internalToolsHeader': '內部工具支援 · WeCode',
  ...
  'settings.launcher.wecode_claude.title': 'WeCode Claude 設定',
  'settings.launcher.wecode_claude.label': 'WeCode Claude 啟動指令',
  'settings.launcher.wecode_codex.title': 'WeCode Codex 設定',
  'settings.launcher.wecode_codex.label': 'WeCode Codex 啟動指令',
  'settings.launcher.wecode_opencode.title': 'WeCode OpenCode 設定',
  'settings.launcher.wecode_opencode.label': 'WeCode OpenCode 啟動指令',
  'settings.launcher.claude.hint': 'Claude Code 的啟動指令。launcher 會自動使用 --dangerously-skip-permissions 非互動模式執行。',
  ...
  'settings.launcher.kimi.hint': 'Kimi Code 的啟動指令。launcher 会自動使用 -p <prompt> --output-format stream-json 非互動模式執行。工作階段恢復使用 -S <session-id>。',
  'settings.launcher.wecode_claude.hint': 'WeCode Claude 的啟動指令。launcher 會自動使用 --dangerously-skip-permissions 非互動模式執行。',
  'settings.launcher.wecode_codex.hint': 'WeCode Codex 的啟動指令。launcher 會自動使用 exec --dangerously-bypass-approvals-and-sandbox 非互動模式執行。',
  'settings.launcher.wecode_opencode.hint': 'WeCode OpenCode 的啟動指令。launcher 會自動使用 run --format json --dangerously-skip-permissions 非互動模式執行。',
  ...
  'settings.launcher.mode': '協定模式',
  'settings.launcher.modeCli': 'CLI',
  'settings.launcher.modeAcp': 'ACP',
  'settings.launcher.presets': '快速預設',
  'settings.launcher.args': '執行參數',
  'settings.launcher.argsPlaceholder': '例如 acp',
  'settings.launcher.acpHint': '基於 Agent Client Protocol (ACP) 標準協定，透過 stdio 進行 JSON-RPC 互動',
  'settings.launcher.globalAdapterReady': '全域適配器已就緒（{bin}），秒級極速直連啟動（提升 10 倍速度，無 npx 開銷）。',
  'settings.launcher.globalAdapterRecommended': '當前透過 npx 運行。推薦運行 “{cmd}” 全域安裝提速 10 倍。',
  'settings.launcher.globalInstallPromptTitle': '推薦：全域安裝 ACP 適配器（提速 10 倍，無冷啟動開銷）',
  'settings.launcher.globalInstallPromptDesc': '當前透過 npx 運行，每次啟動都存在 npm 檢查與網路延遲。建議在終端機中全域安裝一次，即可享受零開銷極速直連。',
  'settings.launcher.copyInstallCmd': '複製安裝命令',
  'settings.launcher.switchToDirect': '套用全域直連（{bin}）',
  'settings.launcher.agyAcpWarning': 'Antigravity CLI (agy) 原生不支援 ACP 模式，建議切換為 CLI 模式。',
  'settings.launcher.kimiAcpWarning': 'Kimi Code CLI (v0.6.0+) 不支援 ACP 模式，建議切換為 CLI 模式。',
  ...
  'git.generateFailedDetail': '產生失敗：{message}',
  ...
  'modal.create.model': '模型',
  'modal.create.modelUnavailable': '暫無可用模型',
  'modal.create.standardAgents': 'Coding Agent',
  'modal.create.internalAgents': '內部工具支援（WeCode）',
